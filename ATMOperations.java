...
import com.codegnan.customExceptions.InsufficientMachineBalanaceException;
...
public class ATMOperations {
	...
	public static void validateAmount(double amount) throws InsufficientMachineBalanaceException {
		if (amount > ATM_MACHINE_BALANCE) {
			throw new InsufficientMachineBalanaceException("Insufficient cash in the Machine");
		}
	}
	// Validate deposit amount to ensure it meets machine requirements
	public static void validateDepositAmount(double amount)
			throws InsufficientMachineBalanaceException, InvalidAmountException {
		...
		if (amount + ATM_MACHINE_BALANCE > 200000.0d) {
			...
			throw new InsufficientMachineBalanaceException(
		...
		while (flag) {
			...
			case 2:
				...
				try {
					...
					System.out.println("==================================================================");
				} catch (InvalidAmountException | InsufficientMachineBalanaceException e) {
				...
				while (true) {
					...
					try {
						...
						if (nextOption.equalsIgnoreCase("N")) {
							...
							| InsufficientMachineBalanaceException e) {
						System.out.println(e.getMessage());
					}
				}
