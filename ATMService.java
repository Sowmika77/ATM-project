...
public interface ATMService {
	...
	//2. will throw insufficientBalanceException if customer has insufficient amount in acc.
	...
	public abstract double withdrawAmount(double wthAmount)
		throws InvalidAmountException, InsufficientBalanceException, InsufficientMachineBalanaceException;
	//to deposit amount
